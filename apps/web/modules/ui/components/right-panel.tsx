			...
			<AnimatePresence mode="wait" initial={false}>
				{!isOpen ? (
					<motion.div
						...
						className="bg-sidebar flex flex-col items-center py-4 gap-4 z-20 h-full"
					>
					...
					<motion.div
						...
						className="bg-background overflow-hidden flex flex-col h-full relative m-2 rounded-xl shadow-sm"
					>

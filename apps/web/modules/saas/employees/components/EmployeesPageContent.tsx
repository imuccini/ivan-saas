							...
							<div className="flex items-start gap-6">
								...
								<div className="flex-1 border-l pl-6">
									<p className="text-sm text-muted-foreground leading-relaxed">
										...
										to specify who can gain authorization
										and which network policies apply.
									</p>
								</div>
							</div>
						</CardContent>
								...
								<div className="flex flex-col items-center gap-2 rounded-lg border p-4 bg-muted/20 hover:bg-muted/40 transition-colors flex-1">
									...
									<div className="h-8 w-8 text-blue-500">
										...
										>
											...
											<path d="M12.7 2.3c-.4-.5-1.1-.5-1.5 0L2.3 11.2c-.4.4-.4 1.1 0 1.5l8.9 8.9c.4.4 1.1.4 1.5 0l8.9-8.9c.4-.4.4-1.1 0-1.5L12.7 2.3z" />
										</svg>
									</div>
